# Praat ZH 汉化术语对照表 (Terminology & Glossary)

本术语表由已翻译的界面词条以及核心帮助手册的译文整理而成，用于规范后续手册翻译与界面翻译的术语一致性。
...
| `SpellingChecker` | **SpellingChecker（拼写检查器）** | 帮助手册译法 |
| `PitchTier` | **PitchTier（音高层）** | 帮助手册译法 |
...
| `ScriptEditor` | **ScriptEditor（脚本编辑器）** | 帮助手册译法 |
| `NotebookEditor` | **NotebookEditor（笔记本编辑器）** | 帮助手册译法 |
...
| `Read from file...` | **Read from file...（从文件读取...）** | 帮助手册译法 |
| `Draw` | **绘制** | 界面菜单译法 |
| `Query` | **查询** | 界面菜单译法 |
...
| `filtered autocorrelation` | **滤波自相关** | 帮助手册译法 |
