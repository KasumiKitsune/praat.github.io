...
DIRECT (PRAAT__BilingualTable) {
	PRAAT
		MelderInfo_open ();
		MelderInfo_writeLine (U"Praat 中英对照表 (Bilingual Terminology Reference)\n");
		...
		MelderInfo_writeLine (U"  Pulses                ===>  脉冲");
		MelderInfo_writeLine (U"  Harmonicity           ===>  谐噪比");
		MelderInfo_writeLine (U"  Voicing               ===>  浊音化 / 浊音");
		MelderInfo_writeLine (U"  Frication             ===>  摩擦");
		MelderInfo_writeLine (U"  Aspiration            ===>  送气");
		MelderInfo_writeLine (U"  Breathiness           ===>  气声");
		...
		MelderInfo_writeLine (U"  Point tier            ===>  点层");
		MelderInfo_writeLine (U"  Interval              ===>  区间");
		MelderInfo_writeLine (U"  Boundary              ===>  边界");
		...
		MelderInfo_writeLine (U"  De-emphasis           ===>  去加重");
		MelderInfo_writeLine (U"  Centre of gravity     ===>  谱重心");
		MelderInfo_writeLine (U"  Spectral tilt         ===>  频谱倾斜");
		MelderInfo_writeLine (U"  LPC (Linear Predictive Coding) ===> LPC / 线性预测编码");
		MelderInfo_writeLine (U"  MFCC                  ===>  倒谱系数 (MFCC)");
		MelderInfo_writeLine (U"  Ltas (Long-term average spectrum) ===> 长期平均谱");
		MelderInfo_writeLine (U"  DTW (Dynamic Time Warping) ===> 动态时间规整");
		MelderInfo_writeLine (U"  BSS (Blind source separation) ===> 盲源分离");
		MelderInfo_writeLine (U"  Diarization           ===>  说话人分离");
		...
		MelderInfo_writeLine (U"  AmplitudeTier         ===>  振幅层");
		MelderInfo_writeLine (U"  FormantGrid           ===>  共振峰网格");
		MelderInfo_writeLine (U"  KlattGrid             ===>  KlattGrid（声学合成专用）");
		MelderInfo_writeLine (U"  Cochleagram           ===>  耳蜗图");
		MelderInfo_writeLine (U"  BarkSpectrogram       ===>  巴克声谱图 / Bark声谱图");
		MelderInfo_writeLine (U"  MelSpectrogram        ===>  Mel 声谱图");
		...
		MelderInfo_writeLine (U"  Open phase            ===>  开放相位");
		MelderInfo_writeLine (U"  Collision phase       ===>  碰撞相位");
		MelderInfo_writeLine (U"  Shepard tone          ===>  谢泼德音");
		MelderInfo_writeLine (U"  Gammatone             ===>  伽马通");
		MelderInfo_writeLine (U"  Tone complex          ===>  复合音");
		MelderInfo_writeLine (U"  Artword               ===>  发音词");
		MelderInfo_writeLine (U"  Tableau grammars      ===>  表格语法（用于优选论 OT）");
		MelderInfo_writeLine (U"  Multidimensional scaling ===> 多维标度分析");
		MelderInfo_writeLine (U"  ChebyshevSeries / LegendreSeries ===> 切比雪夫级数 / 勒让德级数");
		MelderInfo_writeLine (U"\n==========================================================================");
		MelderInfo_writeLine (U"【第二部分：按首字母检索 (Alphabetical Lookup)】\n");
